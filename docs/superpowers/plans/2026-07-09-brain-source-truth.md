...
function createMemorySourcePinProvider({ home23Root, requesterAgent }) {
  ...
  const operationRootFor = operationId => path.join(
    ...
    'brain-operations', validateOperationId(operationId),
  );
  return {
...
~~~text
<home23Root>/instances/<requesterAgent>/runtime/brain-operations/<operationId>/scratch
~~~
