# Historical plan — superseded September 22, 2026

Implementation history, not an active work order. Current direction: [Home23 continuity, updates and portability](../design/HOME-UPDATES-AND-PORTABILITY.md). Do not restart milestones or repeat trials from this archive.
...
priority over public website and download polish in [product delivery](../design/PRODUCT-DELIVERY.md).
