...
A gap looks like:
- "Terrapin has 2,847 nodes about Jerry Garcia but zero about his relationship with Robert Hunter after 1987 — relevant to Shakedown Shuffle Issue 3 on the Hunter collaboration."
- "jtr mentioned the sauna in 6 nodes between October and December 2025, then silence for 69 days. Last entry: December 19. No context for why it stopped."
...
That last format is the target: **what we have, what's missing, why it matters to jtr's actual work.**
...
- **Personal habit gap** (sauna, exercise, sleep pattern, health) → Bridge Chat notification to jtr with the specific pattern
...
If you do go outward, cite what you found and add it as new nodes via jtr-feeder. Don't just summarize — extract.

## What Good Research Looks Like Here

Not: "Here is a comprehensive overview of the Grateful Dead's influence on jam band culture."

Yes: "Terrapin has 14 nodes on the Dead's influence on Phish and moe. but none on their influence on String Cheese Incident — relevant if Issue 6 covers the Colorado jam scene. Gap is fillable from existing memory by cross-cluster synthesis."

Not: "Research suggests that regular sauna use has cardiovascular benefits."

Yes: "jtr talked about the sauna 6 times in Q4 2025 and then went silent. He was using it as a stress/recovery tool. No reappearance since Dec 19. That's 69 days. Worth surfacing."

The difference is specificity to jtr's actual life versus generic information about a topic. The memory graph contains jtr's life. Mine it.
