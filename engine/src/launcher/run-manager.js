...
class RunManager {
   ...
   */
  async forkRun(sourceRunName, newRunName) {
    const sourcePath = path.join(this.runsDir, sourceRunName);
    const destPath = path.join(this.runsDir, newRunName);
   ...
   */
  async createDreamFork(sourceRunName, newRunName, settings = {}) {
    const sourcePath = path.join(this.runsDir, sourceRunName);
    const destPath = path.join(this.runsDir, newRunName);
