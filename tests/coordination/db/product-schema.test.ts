...
const EXPECTED_TABLES = [
  ...
  "terminal_receipts",
  "work_invocation_starts",
  "work_observations",
  "work_planned_invocations",
  "work_retry_provenance",
  "work_thread_presentations",
...
const EXPECTED_INDEXES = [
  ...
  "chess_games_channel_updated",
  "chess_positions_channel_created",
  "chess_turn_intents_due",
  "client_sessions_device_state",
  "client_sessions_family_state",
  "communication_events_conversation_sequence",
  ...
  "messages_notification_recovery_order",
  "messages_reply",
  "messages_tombstone",
...
const EXPECTED_TRIGGERS = [
  ...
  "chess_players_insert",
  "chess_players_update",
  "chess_turn_target_insert",
  "chess_turn_target_update",
  ...
  "event_retention_count_delete",
  "event_retention_count_insert",
  ...
  "work_invocation_starts_no_delete",
  "work_invocation_starts_no_update",
  "work_observations_no_delete",
  "work_observations_no_update",
  "work_planned_invocations_no_delete",
  "work_planned_invocations_no_update",
  "work_thread_presentations_no_delete",
  "work_thread_presentations_no_update",
...
test("schema v1 migrates directly through the reconciled M06-M12 final catalog", async (t) => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      {
        version: 8,
        name: "communication-evidence-indexes",
      ...
      {
        version: 12,
        name: "work-thread-presentation",
        checksum: "53e51e284a48e8f8563cfcab602905652c134ad5d517a90ca8b3b91600e045f3",
        checksumLength: 64,
      },
      {version:13,name:"planned-invocations",checksum:"415a67e278c9e42503293ec32bfedb5c9e5a6c1f942489fdd212ef09e9a334c1",checksumLength:64},
      {version:14,name:"resident-outcomes",checksum:"726089aaa4cf18a3d8285e54e52df5ce6b4ffddf1d8aac3fe13d95a7fe222c42",checksumLength:64},
      {version:15,name:"event-retention-count",checksum:"ad7ee2e588c159d64df0f955a03c221fc85cc598603a03b4c6f459aa2eff0123",checksumLength:64},
  ...
  assert.equal(reopened.openReceipt.migratedFrom, 21);
...
test("restoring an exact schema v1 snapshot permits a clean migration reapply", (t) => {
  ...
  assert.equal(reapplied.openReceipt.schemaVersion, 21);
