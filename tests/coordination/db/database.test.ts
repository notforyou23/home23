...
test("a zero-byte database migrates to the current checksummed schema and reopens", (t) => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      "terminal_receipts",
      "work_invocation_starts", "work_observations", "work_planned_invocations",
  ...
  assert.deepEqual(
    ...
    [
      ...
      { version: 10, checksum: COORDINATION_BOT_LIFECYCLE_RECEIPTS_MIGRATION_CHECKSUM },
      { version: 11, checksum: COORDINATION_ARTIFACT_AUDIO_MPEG_MIGRATION_CHECKSUM },
