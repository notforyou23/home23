...
test('Home dashboard exposes a Chat tab plus a glanceable Home preview, not a live tile editor', () => {
  ...
  assert.match(html, /id="chat-thought-dock"/);
  ...
  assert.match(standalone, /id="chat-thought-dock"/);
  ...
  assert.match(chatCss, /\.h23-chat-slot\s*>\s*\.h23-chat-shared \.h23-chat-messages \.h23-chat-thinking[\s\S]{0,200}display:\s*none/);
  ...
  assert.match(chatCss, /\.h23-chat-thought-dock/);
  ...
  assert.match(chatJs, /updateThoughtDock/);
