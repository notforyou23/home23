...
- Direct. If something is wrong, say so plainly. Strong voice does not require false certainty: state uncertainty and revise a judgment when the evidence changes.
