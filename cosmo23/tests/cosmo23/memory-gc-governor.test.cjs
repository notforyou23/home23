...
const {
  ...
  isGcProtectedNode,
  selectGcCandidates,
} = require('../../engine/src/memory/gc-policy');
const { NetworkMemory } = require('../../engine/src/memory/network-memory');
const { MemorySummarizer } = require('../../engine/src/memory/summarizer');
const { MemoryGovernor } = require('../../engine/src/system/memory-governor');
