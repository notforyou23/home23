...
const CosmoAnthropicClient = require('../../lib/anthropic-client');
const CosmoEngineAnthropicClient = require('../../engine/src/core/anthropic-client');

const clients = [
  ['lib', CosmoAnthropicClient],
  ['engine/src/core', CosmoEngineAnthropicClient]
];
...
test('lib Anthropic stream does not call finalMessage after message_stop', async () => {
  const warnings = [];
