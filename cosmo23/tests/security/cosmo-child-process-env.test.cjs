...
test('every COSMO model or provider controlled subprocess imports and uses the shared scrubber', () => {
  const required = [
    ...
    'engine/src/agents/data-acquisition-agent.js',
    ...
    'engine/src/agents/execution-base-agent.js',
    'engine/src/agents/ide-agent.js',
    'engine/src/interactive/interactive-tools.js',
    'engine/src/execution/environment-provisioner.js',
    'engine/src/execution/execution-monitor.js',
    'engine/src/execution/skill-registry.js',
    'engine/src/execution/tool-discovery.js',
    'engine/src/execution/tool-registry.js',
    'engine/src/ide/tools.js',
    'ide/tools.js',
    'engine/brain-studio/server/tools.js',
    'engine/brain-studio-new/server/tools.js',
  ];
