...
const { createBrainProviderClientRegistry } = require('./brain-provider-client-registry.js');
...
function defaultCodexCredentialsProvider() {
  return (options = {}) => {
    const { getCodexCredentials } = require('../engine/src/services/codex-oauth-engine.js');
