...
const { normalizeProviderCompletion } = require('../../../lib/provider-completion.js');
const { recordCompletionSpend } = require('./spend-meter.js');
const {
  abortableDelay,
  ...
  resultTooLarge,
  throwIfAborted,
} = require('../../../lib/provider-execution.js');
...
class ChatCompletionsClient {
  ...
  async generateWithWebSearch(options = {}) {
    ...
    if (searchQuery) {
      try {
        const { getSearchInstance } = require('../tools/web-search-free.js');
